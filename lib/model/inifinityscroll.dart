...
class InfinityScrollModel {
  ...
  factory InfinityScrollModel.fromJson(Map<String, dynamic> json) {
    return InfinityScrollModel(
      id: json["id"],
      name: json["name"],
...
class _FirebaseFirestoreScreenState extends State<FirebaseFirestoreScreen> {
  List<InfinityScrollModel> infinityData = [];
  ...
  Future<void> _initData() async {
    ...
    setState(() {
      ...
      infinityData = _snapshot.docs
          .map((e) => InfinityScrollModel.fromJson(e.data()))
          .toList();
    });
  }
